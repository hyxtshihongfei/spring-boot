...
import com.elasticsearch.elasticsearchdemo.util.ElasticsearchUtils;
import com.elasticsearch.elasticsearchdemo.util.EsPage;
 ...
 */
	...
	public void searchListData() {
		...
		List<Map<String, Object>> list = ElasticsearchUtils.searchListData("ymq_index", "about_test", System.currentTimeMillis() - 3600 * 1000, System.currentTimeMillis(), 0, "", "", false, "", "name=鹏磊");
	...
	public void searchDataPage() {
		...
		EsPage esPage = ElasticsearchUtils.searchDataPage("ymq_index", "about_test", 10, 5, System.currentTimeMillis() - 3600 * 10000, System.currentTimeMillis(), "", "processTime", false, "about", "about=鹏磊");
